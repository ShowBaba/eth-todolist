...
})(
  {
          ...
          (d.prototype.encodeWithOffset = function (t, e, n, o) {
            ...
            if (c !== s) {
              ...
              if (e.isDynamicArray(u))
                for (var p = c === i ? 2 : 0, h = 0; h < n.length; h++)
                  c === i
                    ? (p += +n[h - 1][0] || 0)
                    : c === a && (p += +(n[h - 1] || [])[0] || 0),
                    (l += r.formatInputInt(o + h * f + 32 * p).encode());
              for (
                var d = c === i ? n.length - 1 : n.length, m = 0;
                m < d;
                m++
              ) {
                var y = l / 2;
                c === i
                  ? (l += this.encodeWithOffset(u, e, n[m + 1], o + y))
                  : c === a && (l += this.encodeWithOffset(u, e, n[m], o + y));
              }
              return l;
            }
            return n;
      ...
      function (t, e, n) {
        ...
        e.exports = {
          ...
          formatOutputReal: function (t) {
            return c(t).dividedBy(new r(2).pow(128));
          },
      ...
      function (t, e, n) {
        ...
        (u.prototype.encode = function (t) {
          ...
          (u.prototype.decode = function (t) {
            ...
            return new o(this._requestManager, n, this._address).decode(t);
          }),
    ...
    29: [
      function (t, e, n) {
        var r = t("./formatters"),
          ...
          c = function (t, e, n, c, u, f, l) {
            var p = this,
              h = {};
            return (
              c.forEach(function (t) {
                t.setRequestManager(n), t.attachToObject(h);
              }),
    ...
    30: [
      function (t, e, n) {
        ...
        var r = t("../utils/utils"),
          ...
          c = function (t) {
            return (
              t.blockNumber && (t.blockNumber = r.toDecimal(t.blockNumber)),
              t.transactionIndex &&
                (t.transactionIndex = r.toDecimal(t.transactionIndex)),
              t.logIndex && (t.logIndex = r.toDecimal(t.logIndex)),
              t
            );
          },
          u = function (t) {
    ...
    41: [
      function (t, e, n) {
        ...
        var s = function () {
          return [
            new r({ name: "version", call: "shh_version", params: 0 }),
            new r({ name: "info", call: "shh_info", params: 0 }),
            new r({
              name: "setMaxMessageSize",
              call: "shh_setMaxMessageSize",
              params: 1,
            }),
            new r({ name: "setMinPoW", call: "shh_setMinPoW", params: 1 }),
            new r({
              name: "markTrustedPeer",
              call: "shh_markTrustedPeer",
              params: 1,
            }),
            new r({ name: "newKeyPair", call: "shh_newKeyPair", params: 0 }),
            new r({
              name: "addPrivateKey",
            ...
            new r({ name: "hasKeyPair", call: "shh_hasKeyPair", params: 1 }),
            new r({
              name: "getPublicKey",
            ...
            new r({ name: "newSymKey", call: "shh_newSymKey", params: 0 }),
            new r({ name: "addSymKey", call: "shh_addSymKey", params: 1 }),
            new r({
              name: "generateSymKeyFromPassword",
              call: "shh_generateSymKeyFromPassword",
              params: 1,
            }),
            new r({ name: "hasSymKey", call: "shh_hasSymKey", params: 1 }),
            new r({ name: "getSymKey", call: "shh_getSymKey", params: 1 }),
            new r({
              name: "deleteSymKey",
        ...
        e.exports = {
          ...
          shh: function () {
            return [
              ...
              new r({ name: "poll", call: "shh_getFilterMessages", params: 1 }),
            ];
          },
        };
      },
              ...
              var n = t,
                ...
                v = ((n.kdf = {}).OpenSSL = {
                  execute: function (t, e, n, r) {
                    r || (r = i.random(8));
                    var o = u.create({ keySize: e + n }).compute(t, r),
                ...
                b = (r.PasswordBasedCipher = g.extend({
                  ...
                  decrypt: function (t, e, n, r) {
                    ...
                    r.iv = o.iv;
                    return g.decrypt.call(this, t, e, o.key, r);
                  },
                }));
            })();
        });
              ...
              o.Utf16LE = {
                ...
                parse: function (t) {
                  for (var n = t.length, o = [], i = 0; i < n; i++)
                    o[i >>> 1] |= e(t.charCodeAt(i) << (16 - (i % 2) * 16));
                  ...
                  for (
                    ...
                    (i =
                      ...
                      (a =
                        (16711935 & ((a << 8) | (a >>> 24))) |
                        (4278255360 & ((a << 24) | (a >>> 8))));
                    ((F = n[o]).high ^= a), (F.low ^= i);
                  }
                  for (var s = 0; s < 24; s++) {
                    for (var p = 0; p < 5; p++) {
                      for (var h = 0, d = 0, m = 0; m < 5; m++) {
                        (h ^= (F = n[p + 5 * m]).high), (d ^= F.low);
                      }
                      var y = l[p];
                      (y.high = h), (y.low = d);
                    }
        ...
        !(function (r, o, i) {
          ...
          return (
            (function () {
              ...
              (n.SHA512 = r._createHelper(f)),
                (n.HmacSHA512 = r._createHmacHelper(f));
            })(),
            t.SHA512
          );
        });
    ...
    84: [
      function (t, e, n) {
        !(function (t) {
          ...
          function s() {
            if (d >= h) throw Error("Invalid byte index");
            var t = 255 & p[d];
          ...
          function c() {
            ...
            if (d > h) throw Error("Invalid byte index");
            if (d == h) return !1;
            if (((t = 255 & p[d]), d++, 0 == (128 & t))) return t;
            if (192 == (224 & t)) {
              if (((e = s()), (i = ((31 & t) << 6) | e) >= 128)) return i;
              throw Error("Invalid continuation byte");
            }
            if (224 == (240 & t)) {
              if (
          ...
          var p,
            ...
            y = {
              version: "2.1.2",
              encode: function (t) {
                for (var e = r(t), n = e.length, o = -1, i = ""; ++o < n; )
                  i += a(e[o]);
                return i;
              },
              decode: function (t) {
                (p = r(t)), (h = p.length), (d = 0);
                for (var e, n = []; !1 !== (e = c()); ) n.push(e);
                return (function (t) {
          ...
          if (
            ...
            if (f) f.exports = y;
              ...
              for (var v in y) g.call(y, v) && (u[v] = y[v]);
            }
          else t.utf8 = y;
        })(this);
      },
        ...
        !(function (t) {
          ...
          function n(t) {
            function e(t, n) {
              ...
              if (!(u instanceof e))
                return (
                  U && I(26, "constructor call without new", t), new e(t, n)
                );
              if (null != n && W(n, 2, 64, D, "base")) {
                ...
                a
                  ? ((u.s = 1 / t < 0 ? ((c = c.slice(1)), -1) : 1),
                    U && c.replace(/^0\.0*|\./, "").length > 15 && I(D, v, t),
                    (a = !1))
              ...
              if ((c = c.slice(i, s + 1)))
                if (
                  ((s = c.length),
                  a && U && s > 15 && (t > x || t !== m(t)) && I(D, v, u.s * t),
                  (o = o - i - 1) > L)
                )
                  u.c = u.e = null;
              ...
              for (
                r < 37 && (t = t.toLowerCase()),
                  m >= 0 &&
                    ...
                    (G = 0),
                    (t = t.replace(".", "")),
                    (p = (d = new e(r)).pow(t.length - m)),
                    (G = u),
                    (d.c = c(f(o(p.c), p.e), 10, n)),
                    (d.e = d.c.length)),
                  s = u = (h = c(t, r, n)).length;
                0 == h[--u];
                h.pop()
              );
              if (!h[0]) return "0";
            ...
            return (
                      ...
                      (!0 === t || !1 === t || 1 === t || 0 === t
                        ? t
                          ? !(t = "undefined" == typeof crypto) &&
                            ...
                            ? (J = !0)
                            : U
                            ? I(2, "crypto unavailable", t ? void 0 : crypto)
                            : (J = !1)
                          : (J = !1)
                        : U && I(2, e + y, t)),
                    (r[e] = J),
                    c((e = "MODULO_MODE")) && W(t, 0, 9, 2, e) && (K = 0 | t),
                    (r[e] = K),
                    c((e = "POW_PRECISION")) && W(t, 0, S, 2, e) && (G = 0 | t),
                    (r[e] = G),
                    c((e = "FORMAT")) &&
                      ("object" == typeof t
                        ? (X = t)
                        : U && I(2, e + " not an object", t)),
                    (r[e] = X),
                    r
                  );
                }),
              ...
              (R.dividedToIntegerBy = R.divToInt =
                function (t, n) {
              ...
              (R.minus = R.sub =
                function (t, n) {
                  var o,
                    ...
                    s,
                    c = this.s;
                  if (((D = 10), (t = new e(t, n)), (n = t.s), !c || !n))
                    return new e(NaN);
                  if (c != n) return (t.s = -n), this.plus(t);
                  var u = this.e / w,
                    f = t.e / w,
                    l = this.c,
                    p = t.c;
                  if (!u || !f) {
                    if (!l || !p)
                      return l ? ((t.s = -n), t) : new e(p ? this : NaN);
                    if (!l[0] || !p[0])
                      return p[0]
                        ? ((t.s = -n), t)
                        : new e(l[0] ? this : 3 == H ? -0 : 0);
                  }
                  if (((u = r(u)), (f = r(f)), (l = l.slice()), (c = u - f))) {
                    for (
                      (s = c < 0) ? ((c = -c), (a = l)) : ((f = u), (a = p)),
                        a.reverse(),
                        n = c;
                      n--;
                      a.push(0)
              ...
              (R.plus = R.add =
                function (t, n) {
                  ...
                  var a = this.e / w,
                    ...
                    u = t.c;
                  if (!a || !s) {
                    if (!c || !u) return new e(i / 0);
                    if (!c[0] || !u[0])
                      return u[0] ? t : new e(c[0] ? this : 0 * i);
                  }
                  if (((a = r(a)), (s = r(s)), (c = c.slice()), (i = a - s))) {
                    for (
                      i > 0 ? ((s = a), (o = u)) : ((i = -i), (o = c)),
                        o.reverse();
                      i--;
                  ...
                  for (
                    ...
                    (i = ((c[--n] = c[n] + u[n] + i) / _) | 0),
                      (c[n] = _ === c[n] ? 0 : c[n] % _);
                  return i && ((c = [i].concat(c)), ++s), O(t, c, s);
                }),
              (R.precision = R.sd =
                function (t) {
                  var e,
                  ...
                  if (
                    (null != t &&
                      ...
                      1 !== t &&
                      0 !== t &&
                      (U && I(13, "argument" + y, t), t != !!t && (t = null)),
                    !r)
                  )
                    return null;
                  if (((n = r.length - 1), (e = n * w + 1), (n = r[n]))) {
                    for (; n % 10 == 0; n /= 10, e--);
                    for (n = r[0]; n >= 10; n /= 10, e++);
                  }
              ...
              (R.squareRoot = R.sqrt =
                function () {
                  ...
                  if (1 !== u || !c || !c[0])
                    return new e(
                      !u || (u < 0 && (!c || c[0])) ? NaN : c ? this : 1 / 0
                    );
                  if (
                    (0 == (u = Math.sqrt(+this)) || u == 1 / 0
                      ? (((n = o(c)).length + f) % 2 == 0 && (n += "0"),
                        (u = Math.sqrt(n)),
                        (f = r((f + 1) / 2) - (f < 0 || f % 2)),
                        (i = new e(
                          (n =
                    ...
                    for ((u = (f = i.e) + l) < 3 && (u = 0); ; )
                      if (
                        ((s = i),
                        (i = p.times(s.plus(T(this, s, l, 1)))),
                        o(s.c).slice(0, u) === (n = o(i.c)).slice(0, u))
                      ) {
                        if (
                          (i.e < f && --u,
                          ...
                          (+n && (+n.slice(1) || "5" != n.charAt(0))) ||
                            (N(i, i.e + M + 2, 1), (t = !i.times(i).eq(this)));
                          break;
                        }
                        if (!a && (N(s, s.e + M + 2, 0), s.times(s).eq(this))) {
                          i = s;
                          break;
                        }
                        (l += 4), (u += 4), (a = 1);
              ...
              (R.times = R.mul =
                function (t, n) {
                  ...
                  for (
                    i = r(this.e / w) + r(t.e / w),
                      t.s *= this.s,
                      (f = b.length) < (h = x.length) &&
                        ((y = b), (b = x), (x = y), (a = f), (f = h), (h = a)),
                      a = f + h,
                      y = [];
                    a--;
                    y.push(0)
                  ...
                  return o ? ++i : y.splice(0, 1), O(t, y, i);
                }),
              ...
              (R.toFraction = function (t) {
                ...
                if (
                  (null != t &&
                    ...
                    ((p = c.isInt()) && !c.lt(E)) ||
                      ...
                      (t = !p && c.c && N(c, c.e + 1, 1).gte(E) ? c : null))),
                  !h)
                )
                ...
                for (
                  l = o(h),
                    ...
                    d.c[0] = k[(s = a % w) < 0 ? w + s : s],
                    t = !t || c.cmp(d) > 0 ? (a > 0 ? d : m) : c,
                    s = L,
                    L = 1 / 0,
                    c = new e(l),
                    u.c[0] = 0;
                  (f = T(c, d, 0, 1)), 1 != (i = r.plus(f.times(y))).cmp(t);

                )
                  (r = y),
                    (y = i),
                    (m = u.plus(f.times((i = m)))),
                    (u = i),
                    (d = c.minus(f.times((i = d)))),
                    (c = i);
                return (
                  (i = T(t.minus(r), y, 0, 1)),
                  (u = u.plus(i.times(m))),
                  ...
                  (n =
                    T(m, y, a, H)
                      .minus(this)
                      .abs()
                      .cmp(T(u, r, a, H).minus(this).abs()) < 1
              ...
              (R.toPower = R.pow =
                function (t, n) {
                  ...
                  for (
                    n
                      ? t > 1 && s.gt(E) && s.isInt() && n.gt(E) && n.isInt()
                        ? (s = s.mod(n))
                        : ((i = n), (n = null))
                      : G && (r = d(G / w + 2)),
                      o = new e(E);
